...
add_parameter S_DATA_WIDTH INTEGER 32
set_parameter_property S_DATA_WIDTH DEFAULT_VALUE 32
set_parameter_property S_DATA_WIDTH DISPLAY_NAME S_DATA_WIDTH
set_parameter_property S_DATA_WIDTH TYPE INTEGER
set_parameter_property S_DATA_WIDTH UNITS None
set_parameter_property S_DATA_WIDTH ALLOWED_RANGES -2147483648:2147483647
set_parameter_property S_DATA_WIDTH HDL_PARAMETER true
add_parameter S_STRB_WIDTH INTEGER 4
set_parameter_property S_STRB_WIDTH DEFAULT_VALUE 4
set_parameter_property S_STRB_WIDTH DISPLAY_NAME S_STRB_WIDTH
set_parameter_property S_STRB_WIDTH TYPE INTEGER
set_parameter_property S_STRB_WIDTH UNITS None
set_parameter_property S_STRB_WIDTH ALLOWED_RANGES -2147483648:2147483647
set_parameter_property S_STRB_WIDTH HDL_PARAMETER true
...
add_interface_port altera_axi_slave s_axi_awaddr awaddr Input ADDR_WIDTH
add_interface_port altera_axi_slave s_axi_awburst awburst Input 2
add_interface_port altera_axi_slave s_axi_awcache awcache Input 4
add_interface_port altera_axi_slave s_axi_awid awid Input ID_WIDTH
add_interface_port altera_axi_slave s_axi_awlen awlen Input 4
add_interface_port altera_axi_slave s_axi_awprot awprot Input 3
add_interface_port altera_axi_slave s_axi_awready awready Output 1
add_interface_port altera_axi_slave s_axi_awsize awsize Input 3
add_interface_port altera_axi_slave s_axi_awuser awuser Input AWUSER_WIDTH
add_interface_port altera_axi_slave s_axi_awvalid awvalid Input 1
add_interface_port altera_axi_slave s_axi_bid bid Output ID_WIDTH
add_interface_port altera_axi_slave s_axi_bready bready Input 1
add_interface_port altera_axi_slave s_axi_bresp bresp Output 2
add_interface_port altera_axi_slave s_axi_bvalid bvalid Output 1
add_interface_port altera_axi_slave s_axi_wdata wdata Input S_DATA_WIDTH
add_interface_port altera_axi_slave s_axi_wlast wlast Input 1
add_interface_port altera_axi_slave s_axi_wready wready Output 1
add_interface_port altera_axi_slave s_axi_wstrb wstrb Input S_STRB_WIDTH
add_interface_port altera_axi_slave s_axi_wvalid wvalid Input 1
add_interface_port altera_axi_slave s_axi_araddr araddr Input ADDR_WIDTH
add_interface_port altera_axi_slave s_axi_arburst arburst Input 2
add_interface_port altera_axi_slave s_axi_arcache arcache Input 4
add_interface_port altera_axi_slave s_axi_arid arid Input ID_WIDTH
add_interface_port altera_axi_slave s_axi_arlen arlen Input 4
add_interface_port altera_axi_slave s_axi_arprot arprot Input 3
add_interface_port altera_axi_slave s_axi_arready arready Output 1
add_interface_port altera_axi_slave s_axi_arsize arsize Input 3
add_interface_port altera_axi_slave s_axi_arvalid arvalid Input 1
add_interface_port altera_axi_slave s_axi_rdata rdata Output S_DATA_WIDTH
add_interface_port altera_axi_slave s_axi_rid rid Output ID_WIDTH
add_interface_port altera_axi_slave s_axi_rlast rlast Output 1
add_interface_port altera_axi_slave s_axi_rready rready Input 1
add_interface_port altera_axi_slave s_axi_rresp rresp Output 2
add_interface_port altera_axi_slave s_axi_rvalid rvalid Output 1
add_interface_port altera_axi_slave s_axi_wid wid Input ID_WIDTH
add_interface_port altera_axi_slave s_axi_arlock arlock Input 2
add_interface_port altera_axi_slave s_axi_awlock awlock Input 2
