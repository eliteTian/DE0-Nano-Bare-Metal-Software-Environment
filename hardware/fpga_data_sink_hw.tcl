...
# Sun Nov 23 18:50:31 PST 2025
# DO NOT MODIFY


# 
# fpga_data_sink "f_dat_snk" v1.0
#  2025.11.23.18:50:31
# 
# 
...
set_module_property NAME fpga_data_sink
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "custom logic"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME f_dat_snk
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL fpga_data_sink
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file fpga_data_sink.v VERILOG PATH soc_system/synthesis/custom/fpga_data_sink.v TOP_LEVEL_FILE
...
set_interface_property axi4stream_slave associatedReset reset
...
add_interface_port axi4stream_slave axis4_s_tdata tdata Input 8
add_interface_port axi4stream_slave axis4_s_tlast tlast Input 1
add_interface_port axi4stream_slave axis4_s_tready tready Output 1
add_interface_port axi4stream_slave axis4_s_tvalid tvalid Input 1
